            ...
            <div class="video-content" >
                <div class="content" v-if="loaded">
                    <div class="media-metadata">
                        <a class="poster-image-wrapper" :href="metadat.url" >
                            <span class="poster-hover-layer">to series</span>
                            <img v-if="Object.keys(metadat.images).length > 1" :src="metadat.images?.poster_tall[image].source" class="c-content-image" :alt="metadat.title">
                        </a>
...
export default {
    ...
    beforeMount: async function () {
        try {
            ...
            this.image = Math.floor(this.metadat.images.poster_tall.length / 2 - 1);
